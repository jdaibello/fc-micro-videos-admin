...
describe('CategorySequelizeRepository Integration Tests', () => {
  ...
  describe('search method tests', () => {
    ...
    test('should apply pagination and filter', async () => {
      ...
      let searchOutput = await repository.search(new CategorySearchParams({ page: 1, per_page: 2, filter: 'TEST' }));
      ...
      searchOutput = await repository.search(new CategorySearchParams({ page: 2, per_page: 2, filter: 'TEST' }));
    ...
    test('should apply pagination and sort', async () => {
