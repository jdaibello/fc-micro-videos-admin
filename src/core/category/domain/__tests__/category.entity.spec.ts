...
describe('Category Validator Unit Test', () => {
  describe('create command', () => {
    test('should throw an invalid category with name property', () => {
    ...
    test('should throw an invalid category with description property', () => {
      expect(() => Category.create({ description: 5 } as any)).containsErrorMessages({
        description: ['description must be a string'],
      });
    });

    test('should throw an invalid category with is_active property', () => {
